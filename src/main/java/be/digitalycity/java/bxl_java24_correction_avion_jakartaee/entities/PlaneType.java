...
public class PlaneType extends BaseEntity<Long> {
    ...
    public PlaneType(String name, String manufacturer, double power, int placeCount) {
        this.name = name;
        this.manufacturer = manufacturer;
        this.power = power;
        this.seatCount = placeCount;
    }
    ...
    public void setPower(@Range(min = 0) double power) {
        this.power = power;
    }
    ...
    public void setSeatCount(@Range(min = 0) int seatCount) {
